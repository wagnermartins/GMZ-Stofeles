...
<section id="content">
    ...
    <div class="column left">
        ...
        <section>
            ...
            <div>
                <?php echo $this->Form->input('password', array('class' => 'passwd', 'value' => '00000', 'minlength' => '6', 'placeholder' => 'Senha')); ?>
                <?php echo $this->Form->input('confirm_password', array('class' => 'confirm_password', 'value' => '00000', 'type' => 'password', 'minlength' => '6', 'placeholder' => 'Digite sua senha novamente')); ?>
            </div>
        </section>
    </div>
